...
class SalesControllerImpl extends SalesController {
  static SalesControllerImpl get instance => Get.find();
    ...
    try {
      ...
      if (StatusRequest.success == statusRequest) {
        if (response['status'] == "success") {
          ...
          SalesTableControllerImp controller =
              Get.find<SalesTableControllerImp>();
          controller.viewData();
